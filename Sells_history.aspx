<%@ Page Title="" Language="C#" MasterPageFile="~/Admin_Master.Master" AutoEventWireup="true" CodeBehind="Sells_history.aspx.cs" Inherits="Inventory_Managament.Sells_history" %>
...
&nbsp;</p>
    <p>
        <strong>
        <asp:Label ID="Label1" runat="server" CssClass="auto-style9" Text=".  Sells History  ."></asp:Label>
        </strong>
    <p>
